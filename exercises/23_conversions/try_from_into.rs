...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        Ok(Self {
            red: u8::try_from(arr[0]).map_err(|_e| IntoColorError::IntConversion)?,
            green: u8::try_from(arr[1]).map_err(|_e| IntoColorError::IntConversion)?,
            blue: u8::try_from(arr[2]).map_err(|_e| IntoColorError::IntConversion)?,
        })
    }
}
...
impl TryFrom<&[i16]> for Color {
    ...
    fn try_from(slice: &[i16]) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            red: u8::try_from(slice[0]).map_err(|_e| IntoColorError::IntConversion)?,
            green: u8::try_from(slice[1]).map_err(|_e| IntoColorError::IntConversion)?,
            blue: u8::try_from(slice[2]).map_err(|_e| IntoColorError::IntConversion)?,
        })
    }
}
